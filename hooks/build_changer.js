...
module.exports = function (context) {
    ...
    utils.moveGSFiles(context.opts.projectRoot + confs.androidPath + appId + '/google-services.json', context.opts.projectRoot + confs.androidPath + 'google-services.json')
}