...
module.exports = function (context) {
    ...
    utils.moveGSFiles(context.opts.projectRoot + confs.androidPath + appId + confs.firebaseSuffix + '/google-services.json', context.opts.projectRoot + '/platforms/android/app/src'  + '/google-services.json')
}